                ...
                <section className="h-screen">
                    <div className="h-full">
                        ...
                        <div className="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between">
                            ...
                            <div className="mb-12 p-8 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
                                <form>
                                    {/* <!--Sign in section--> */}
                                    ...
                                    <div className="my-4 flex items-center before:mt-0.5 before:flex-1 before:border-t before:border-neutral-300 after:mt-0.5 after:flex-1 after:border-t after:border-neutral-300">
                                        <p className="mx-4 mb-0 text-center font-bold text-lg dark:text-black">
                                            Or
                                        </p>
                                    </div>
                                    ...
                                    <div className="relative mb-6" data-te-input-wrapper-init>
                                        ...
                                        <label
                                            ...
                                            className="pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[2.15] text-neutral-600 transition-all duration-200 ease-out peer-focus:-translate-y-[1.15rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[1.15rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-600 dark:peer-focus:text-primary"
                                        >
                                            Email address
                                        </label>
                                    </div>
                                    ...
                                    <div className="relative mb-6" data-te-input-wrapper-init>
                                        <input
                                            type="password"
                                            className="peer block min-h-[auto] w-full rounded border-2 bg-transparent px-3 py-[0.32rem] leading-[2.15] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-600 dark:placeholder:text-neutral-600 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                                    ...
                                    <div className="text-center lg:text-left">
                                        ...
                                        <p className="mb-0 mt-2 pt-1 text-sm font-semibold">
                                            ...
                                            <a
                                                href="#!"
                                                className="text-danger transition text-blue-500 duration-150 ease-in-out hover:text-danger-600 focus:text-danger-600 active:text-danger-700"
                                            >
                                                 Register
                                            </a>
                                        </p>
