        ...
        <>
            ...
            >
                <div className="flex w-full flex-wrap items-center justify-between px-3">
                    <div>
                        <div className="mx-2 my-1 flex items-center text-neutral-900 hover:text-neutral-900 focus:text-neutral-900 lg:mb-0 lg:mt-0">
                            <img
                                className="mr-2"
                    ...
                    >
                        ...
                        <div className="flex items-center">
                            <button
                                ...
                                className="mr-3 inline-block rounded px-6 pb-2 pt-2.5 text-blue-400 text-xs font-medium uppercase leading-normal text-primary transition duration-150 ease-in-out hover:bg-neutral-100 hover:text-primary-600 focus:text-primary-600 focus:outline-none focus:ring-0 active:text-primary-700 motion-reduce:transition-none"
                            >
                                Login
                            </button>
                            <button
